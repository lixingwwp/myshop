 ...
 */
class m170612_032501_create_goods_table extends Migration
{
    /**
     * @inheritdoc
     */
    public function up()
    {
        $this->createTable('goods', [
            ...
            //sn	varchar(20)	货号
            'sn' =>$this->string(20)->comment('商品编号'),
            ...
            'market_price' =>$this->decimal(9,2)->comment('市场价格'),
            //shop_price	decimal(10, 2)	商品价格
            'shop_price' =>$this->decimal(9,2)->comment('商品价格'),
            //stock	int	库存

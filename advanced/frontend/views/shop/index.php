<div class="nav w1210 bc mt10">
    ...
    <div class="category fl"> <!-- 非首页，需要添加cat1类 -->
        <div class="cat_hd">  <!-- 注意，首页在此div上只需要添加cat_hd类，非首页，默认收缩分类时添加上off类，鼠标滑过时展开菜单则将off类换成on类 -->
            ...
            <div class="cat_bd"> <?=frontend\widgets\CategoryWidget::widget()?></div>
...
<div class="colligate w1210 bc mt10">
    ...
    <div class="slide fl">
        <div class="area">
            <div class="slide_items">
                <ul>
                    <li><a href=""><img src="<?php Yii::getAlias('@web')?>/images/index_slide1.jpg" alt="" /></a></li>
                    <li><a href=""><img src="<?php Yii::getAlias('@web')?>/images/index_slide2.jpg" alt="" /></a></li>
                    <li><a href=""><img src="<?php Yii::getAlias('@web')?>/images/index_slide3.jpg" alt="" /></a></li>
                    <li><a href=""><img src="<?php Yii::getAlias('@web')?>/images/index_slide4.jpg" alt="" /></a></li>
                    <li><a href=""><img src="<?php Yii::getAlias('@web')?>/images/index_slide5.jpg" alt="" /></a></li>
                    <li><a href=""><img src="<?php Yii::getAlias('@web')?>/images/index_slide6.jpg" alt="" /></a></li>
                </ul>
            </div>
    ...
    <div class="coll_right fl ml10">
        <div class="ad"><a href=""><img src="<?php Yii::getAlias('@web')?>/images/ad.jpg" alt="" /></a></div>
        ...
        <div class="service mt10">
            ...
            <div class="service_wrap">
                ...
                <div class="travel none">
                    <ul>
                        <li>
                            <a href=""><img src="<?php Yii::getAlias('@web')?>/images/holiday.jpg" alt="" /></a>
                            <a href="" class="button">度假查询</a>
                        </li>
                        <li>
                            <a href=""><img src="<?php Yii::getAlias('@web')?>/images/scenic.jpg" alt="" /></a>
                ...
                <div class="lottery none">
                    <p><img src="<?php Yii::getAlias('@web')?>/images/lottery.jpg" alt="" /></p>
                </div>
                <!-- 彩票 end -->
                ...
                <div class="game none">
                    <ul>
                        <li><a href=""><img src="<?php Yii::getAlias('@web')?>/images/sanguo.jpg" alt="" /></a></li>
                        <li><a href=""><img src="<?php Yii::getAlias('@web')?>/images/taohua.jpg" alt="" /></a></li>
                        <li><a href=""><img src="<?php Yii::getAlias('@web')?>/images/wulin.jpg" alt="" /></a></li>
                    </ul>
                </div>
                <!-- 游戏 end -->
            </div>
...
<div class="guide w1210 bc mt15">
        ...
        <div class="guide_wrap">
            ...
            <div class="crazy">
                <ul>
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?php Yii::getAlias('@web')?>/images/crazy1.jpg" alt="" /></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?php Yii::getAlias('@web')?>/images/crazy2.jpg" alt="" /></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?php Yii::getAlias('@web')?>/images/crazy3.jpg" alt="" /></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?php Yii::getAlias('@web')?>/images/crazy4.jpg" alt="" /></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?php Yii::getAlias('@web')?>/images/crazy5.jpg" alt="" /></a></dt>
            ...
            <div class="hot none">
                <ul>
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?php Yii::getAlias('@web')?>/images/hot1.jpg" alt="" /></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?php Yii::getAlias('@web')?>/images/hot2.jpg" alt="" /></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?php Yii::getAlias('@web')?>/images/hot3.jpg" alt="" /></a></dt>
            ...
            <div class="recommend none">
                <ul>
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?php Yii::getAlias('@web')?>/images/recommend1.jpg" alt="" /></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?php Yii::getAlias('@web')?>/images/recommend2.jpg" alt="" /></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?php Yii::getAlias('@web')?>/images/recommend3.jpg" alt="" /></a></dt>
    ...
    <div class="sidebar fl ml10">
        ...
        <div class="sidebar_wrap">
            <dl class="first">
                <dt class="fl"><a href=""><img src="<?php Yii::getAlias('@web')?>/images/viewsonic.jpg" alt="" /></a></dt>
            ...
            <dl>
                <dt class="fr"><a href=""><img src="<?php Yii::getAlias('@web')?>/images/samsung.jpg" alt="" /></a></dt>
...
<div class="floor1 floor w1210 bc mt10">
    ...
    <div class="floor_left fl">
        ...
        <div class="cate fl">
            ...
            <div class="cate_wrap">
                ...
                <p><a href=""><img src="<?php Yii::getAlias('@web')?>/images/notebook.jpg" alt="" /></a></p>
            </div>
            ...
            <div class="goodslist_wrap">
                <div>
                    <ul>
                        <li>
                            <dl>
                                <dt><a href=""><img src="<?php Yii::getAlias('@web')?>/images/hpG4.jpg" alt="" /></a></dt>
                        ...
                        <li>
                            <dl>
                                <dt><a href=""><img src="<?php Yii::getAlias('@web')?>/images/thinkpad e420.jpg" alt="" /></a></dt>
                        ...
                        <li>
                            <dl>
                                <dt><a href=""><img src="<?php Yii::getAlias('@web')?>/images/acer4739.jpg" alt="" /></a></dt>
                        ...
                        <li>
                            <dl>
                                <dt><a href=""><img src="<?php Yii::getAlias('@web')?>/images/lh531.jpg" alt="" /></a></dt>
                ...
                <div class="none">
                    <ul>
                        ...
                        <li>
                            <dl>
                                <dt><a href=""><img src="<?php Yii::getAlias('@web')?>/images/qinghuax2.jpg" alt="" /></a></dt>
                                <dd><a href="">清华同方精锐X2笔记本 </a></dd>
                                <dd><span>售价：</span> <strong>￥2499.00</strong></dd>
                            </dl>
                        </li>
    ...
    <div class="sidebar fl ml10">
        ...
        <div class="brand">
            ...
            <div class="sidebar_wrap">
                <ul>
                    <li><a href=""><img src="<?php Yii::getAlias('@web')?>/images/dell.gif" alt="" /></a></li>
                    <li><a href=""><img src="<?php Yii::getAlias('@web')?>/images/acer.gif" alt="" /></a></li>
                    <li><a href=""><img src="<?php Yii::getAlias('@web')?>/images/fujitsu.jpg" alt="" /></a></li>
                    <li><a href=""><img src="<?php Yii::getAlias('@web')?>/images/hp.jpg" alt="" /></a></li>
                    <li><a href=""><img src="<?php Yii::getAlias('@web')?>/images/lenove.jpg" alt="" /></a></li>
                    <li><a href=""><img src="<?php Yii::getAlias('@web')?>/images/samsung.gif" alt="" /></a></li>
                    <li><a href=""><img src="<?php Yii::getAlias('@web')?>/images/dlink.gif" alt="" /></a></li>
                    <li><a href=""><img src="<?php Yii::getAlias('@web')?>/images/seagate.jpg" alt="" /></a></li>
                    <li><a href=""><img src="<?php Yii::getAlias('@web')?>/images/intel.jpg" alt="" /></a></li>
                </ul>
            </div>
        </div>
        <!-- 品牌旗舰店 end -->
        ...
        <!-- 广告 start -->
        <div class="ads mt10">
            <a href=""><img src="<?php Yii::getAlias('@web')?>/images/canon.jpg" alt="" /></a>
        </div>
        <!-- 广告 end -->
    </div>
    <!-- 右侧 end -->

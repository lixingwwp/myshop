...
<div class="list w1210 bc mt10">
    ...
    <div class="breadcrumb">
        <h2>当前位置：<a href="">首页</a> > <a href=""><?=$top?$top->name:''?></a></h2>
    </div>
    <!-- 面包屑导航 end -->
    ...
    <div class="list_left fl mt10">
        ...
        <div class="catlist">
            ...
            <div class="catlist_wrap">
                <?php foreach ($goodsCategories as $category):?>
                <div class="child">
        ...
        <div class="newgoods leftbar mt10">
            ...
            <div class="leftbar_wrap">
                <ul>
                    <?php foreach ($newGoods as $newgood):?>
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?='http://admin.yiishop.com'.$newgood->logo?>" alt="" /></a></dt>
                            <dd><a href=""><?=$newgood->name?></dd>
                            <dd><strong><?=$newgood->shop_price?></strong></dd>
                        </dl>
                    </li>
                    <?php endforeach;?>
                </ul>
    ...
    <div class="list_bd fl ml10 mt10">
        ...
        <div class="goodslist mt10">
            <ul>
                <?php foreach ($cate_id as $id):?>
                    <?php $goods = \backend\models\Goods::find()->where(['goods_category_id'=>$id])->all();
                    foreach ($goods as $good):?>
                <li>
                    <dl>
                        <dt><a href=""><img src="<?='http://admin.yiishop.com'.$good->logo?>" alt="" /></a></dt>
                        <dd><?=\yii\helpers\Html::a($good->name,['shop/goods','id'=>$good->id])?></dt>
        ...
        <?php }else{?>
            <div class="goodslist mt10">
                <ul>
                    <?php foreach ($cate_id as $id):?>
                        <?php $goods = \backend\models\Goods::find()->where(['id'=>$id])->all();
                        foreach ($goods as $good):?>
                            <li>
                                <dl>
                                    <dt><a href=""><img src="<?='http://admin.yiishop.com'.$good->logo?>" alt="" /></a></dt>

...
<?php \frontend\assets\GoodsAsset::register($this)?>
<div class="main w1210 mt10 bc">
    <!-- 面包屑导航 start -->
    <div class="breadcrumb">

        <h2>当前位置：<a href="">首页</a> > <?=\yii\helpers\Html::a($goods->goodsCategory->father->name,['shop/list','id'=>$goods->goodsCategory->father->id])?> ><?=\yii\helpers\Html::a($goods->goodsCategory->name,['shop/list','id'=>$goods->goodsCategory->id]) ?> <?=$goods->name?></h2>
    </div>
    <!-- 面包屑导航 end -->
    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <div class="preview fl">
                <div class="midpic">
                    <a href="/images/preview_l1.jpg/images/preview_l1.jpg" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <img  height="350" width="350" src="<?='http://admin.yiishop.com'.$goods->logo?>" alt="" />               <!-- 第一幅图片的中图 -->
                    </a>
                </div>
            ...
            <div class="goodsinfo fl ml10">
                ...
                <form action="<?=\yii\helpers\Url::to(['shop/add'])?>" method="post" class="choose">
                    <ul>
